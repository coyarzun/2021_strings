...
void xtraInput_12(float v){ println("sC/s1 "+v); a1 = v;}
void xtraInput_13(float v){ println("sC/s2 "+v); c1 = v;}

void xtraInput_14(float v){ println("sC/s7 "+v); a1 = v;}
void xtraInput_15(float v){ println("sC/s8 "+v); a2 = v;}
void xtraInput_16(float v){ println("sC/s9 "+v); c1 = v;}
void xtraInput_17(float v){ println("sA/s10 "+v); c2 = v;}
