void oscSetup(){
  ...
  oscP5.plug(this, "xtraInput_12", "/sC/s1");
  oscP5.plug(this, "xtraInput_13", "/sC/s2");
  oscP5.plug(this, "xtraInput_14", "/sC/s7");
  oscP5.plug(this, "xtraInput_15", "/sC/s8");
  oscP5.plug(this, "xtraInput_16", "/sC/s9");
  oscP5.plug(this, "xtraInput_17", "/sA/s10");
  oscP5.plug(this, "xtraInput_18", "/sA/s1");
...
float a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,c1,c2,c3,c4,c5,c6,x1,x2,x3,x4;
...
void xtraInput_12(float v){ println("sC/s1 "+v); a5 = v;}//black
void xtraInput_13(float v){ println("sC/s2 "+v); a6 = v;}//black

void xtraInput_14(float v){ println("sC/s7 "+v); a7 = v;}//vapor
void xtraInput_15(float v){ println("sC/s8 "+v); a8 = v;}//vapor
void xtraInput_16(float v){ println("sC/s9 "+v); a9 = v;}//vapor
void xtraInput_17(float v){ println("sA/s10 "+v); c5 = v;}
void xtraInput_18(float v){ println("sA/s1 "+v); c6 = v;}
